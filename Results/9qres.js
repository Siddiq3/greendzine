...
const Qres9 = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableWithoutFeedback onPress={() => navigation.navigate('9thToday Answer')} style={styles.button}
                onPressOut={() => {
                    if (interstitialLoaded) {

                        interstitial.show();
                    } else { navigation.navigate('9thToday Answer') }
                }}
            >
