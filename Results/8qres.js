...
const Qres8 = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableWithoutFeedback onPress={() => navigation.navigate('8thToday Answer')} style={styles.button}
                onPressOut={() => {
                    if (interstitialLoaded) {

                        interstitial.show();
                    } else { navigation.navigate('8thToday Answer') }
                }}
            >
